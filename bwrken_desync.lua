local g,h,s=game:GetService("HttpService"),game:GetService("CoreGui"),Instance.new;local sg=s("ScreenGui");sg.Parent=h;sg.ResetOnSpawn=false;local f=s("Frame");f.Parent=sg;f.Size=UDim2.new(0,340,0,200);f.Position=UDim2.new(0.5,-170,0.5,-100);f.BackgroundColor3=Color3.fromRGB(10,10,20);f.BorderColor3=Color3.fromRGB(0,200,255);f.BorderSizePixel=2;local t=s("TextLabel");t.Parent=f;t.Size=UDim2.new(1,0,0,40);t.BackgroundColor3=Color3.fromRGB(0,20,40);t.BorderSizePixel=0;t.Text="Bwrken Desync | Key System";t.TextColor3=Color3.fromRGB(0,220,255);t.TextSize=14;t.Font=Enum.Font.GothamBold;local i=s("TextBox");i.Parent=f;i.Size=UDim2.new(0.85,0,0,36);i.Position=UDim2.new(0.075,0,0,60);i.BackgroundColor3=Color3.fromRGB(5,15,30);i.BorderColor3=Color3.fromRGB(0,100,150);i.TextColor3=Color3.fromRGB(200,230,255);i.PlaceholderText="Enter your key...";i.Text="";i.TextSize=13;i.Font=Enum.Font.Code;i.ClearTextOnFocus=false;local b=s("TextButton");b.Parent=f;b.Size=UDim2.new(0.85,0,0,34);b.Position=UDim2.new(0.075,0,0,106);b.BackgroundColor3=Color3.fromRGB(0,80,140);b.BorderSizePixel=0;b.Text="VERIFY KEY";b.TextColor3=Color3.fromRGB(255,255,255);b.TextSize=13;b.Font=Enum.Font.GothamBold;local l=s("TextLabel");l.Parent=f;l.Size=UDim2.new(1,0,0,30);l.Position=UDim2.new(0,0,0,150);l.BackgroundTransparency=1;l.Text="Enter your key above";l.TextColor3=Color3.fromRGB(150,150,180);l.TextSize=11;l.Font=Enum.Font.Gotham;local _ENV=_ENV;b.MouseButton1Click:Connect(function()local k=i.Text:gsub("%s+","");if k==""then l.Text="Please enter a key";return end;l.Text="Verifying...";l.TextColor3=Color3.fromRGB(255,200,0);local ok,r=pcall(function()return g:JSONDecode(game:HttpGet("https://gist.githubusercontent.com/sus893/0746492d540c669dac3cfde3b05f7b60/raw/8341afc4c7ef5c7bd46d752d17451a745faf8155/keys.json"))end);if
repeat task.wait() until not game:GetService("CoreGui"):FindFirstChild("ScreenGui")
```

So it looks like:
```
LINE 1: local g,h,s=game:GetService... (key system - already there)
LINE 2: repeat task.wait() until not game:GetService("CoreGui"):FindFirstChild("ScreenGui")
LINE 3: local Players = game:GetService("Players")
LINE 4: (rest of your script...)
